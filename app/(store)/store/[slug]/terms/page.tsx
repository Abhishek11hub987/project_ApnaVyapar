  ...
  return (
    <div className="min-h-screen bg-navy text-white relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        {/* Warning Banner */}
        <div className="max-w-3xl mx-auto mb-16 glass-card p-6 rounded-3xl border-white/10 shadow-lg flex gap-4 items-start bg-amber-500/5">
          <AlertTriangle className="w-6 h-6 shrink-0 text-amber-500 mt-1" />
          <div>
            <h3 className="text-lg font-bold text-white mb-2">Platform Disclaimer</h3>
        ...
        <div className="max-w-3xl mx-auto glass-card p-8 md:p-12 rounded-3xl border-white/10 shadow-2xl">
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/10">
            ...
            <h2 className="text-2xl font-bold text-white tracking-tight">Terms Details</h2>
          </div>
