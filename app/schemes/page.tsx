...
export default function SchemesPage() {
  ...
  return (
    <main className="min-h-screen bg-surface-secondary pb-32">
      <div className="bg-white border-b border-gray-100 pt-10 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-2xl font-extrabold text-gray-900 mb-2 tracking-tight">Government Schemes</h1>
          <p className="text-gray-500 text-base max-w-2xl mb-6 font-medium">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 relative z-10">
        <div className="card p-4 mb-8 flex gap-2 overflow-x-auto scrollbar-hide">
          {CATEGORIES.map(cat => (
            <button
              key={cat}
