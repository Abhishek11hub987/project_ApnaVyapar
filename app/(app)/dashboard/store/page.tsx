  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto pb-20">
      <div className="mb-10 text-center">
        <div className="inline-flex items-center justify-center p-3 bg-gray-50 rounded-lg mb-4 border border-gray-100">
          <Sparkles className="text-gray-900 w-8 h-8" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {/* Basics Card */}
              <div className="bg-white border border-gray-100 rounded-lg p-8 hover:border-gray-200 transition-colors group relative overflow-hidden shadow-card">
              ...
              <div className="bg-white border border-gray-100 rounded-lg p-8 hover:border-gray-200 transition-colors group relative overflow-hidden shadow-card">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
                  ...
                  <div className="flex-1">
                    <label className="cursor-pointer bg-white text-gray-700 border border-gray-200 px-4 py-2 rounded-lg hover:bg-gray-50 transition-all inline-flex items-center gap-2 text-sm font-medium">
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 z-40">
            <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                {storeUrl && formData.id && (
                  <>
                    <button
                      ...
                      className="bg-white text-gray-700 border border-gray-200 px-4 py-2 rounded-lg hover:bg-gray-50 text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap"
                    >
                    ...
                    <a
                      ...
                      className="bg-white text-[#25D366] border border-[#25D366]/30 px-4 py-2 rounded-lg hover:bg-[#25D366]/10 text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap"
                    >
              ...
              <button
                type="submit"
                disabled={saving}
                className="bg-gray-900 text-white px-6 py-2.5 rounded-lg hover:bg-gray-800 transition-all flex items-center justify-center gap-2 disabled:opacity-50 font-medium"
              >
                {saving ? (
