  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight mb-1">Add Customer</h1>
          <p className="text-white/60">Manually add a new customer profile to your CRM.</p>
        </div>
      </div>
