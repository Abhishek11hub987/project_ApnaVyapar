...
function ChatContent() {
  ...
  return (
    <div className="flex flex-col h-full md:h-[calc(100vh-200px)] bg-white/60 backdrop-blur-xl md:border md:border-gray-100 md:rounded-3xl overflow-hidden shadow-card transition-all duration-300">
      {/* Header */}
      <div className="bg-white/80 border-b border-gray-100 px-6 py-4 flex justify-between items-center z-10 shrink-0">
      ...
      <div className="bg-white border-t border-gray-100 p-4 transition-colors">
        <div className="max-w-4xl mx-auto flex items-center gap-2 mb-3 overflow-x-auto no-scrollbar">
          <button 
            ...
            className="shrink-0 flex items-center gap-1.5 text-xs font-bold bg-blue-50 text-blue-700 hover:bg-blue-100 px-4 py-2 rounded-full border border-blue-100 shadow-sm transition-all"
          >
        ...
        <form onSubmit={handleSubmit} className="relative flex items-center max-w-4xl mx-auto">
          <input
            ...
            className="w-full bg-white border border-gray-200 text-gray-900 rounded-2xl pl-6 pr-24 py-4 text-[15px] focus:outline-none focus:ring-4 focus:ring-accent-500/10 focus:border-accent-300 transition-all placeholder-gray-400 font-medium shadow-sm"
            disabled={isLoading}
          />
          <div className="absolute right-2 flex items-center gap-1.5">
            ...
            <button 
              ...
              className="w-10 h-10 flex items-center justify-center bg-gray-900 text-white rounded-xl shadow-md disabled:opacity-50 disabled:bg-gray-300 hover:bg-gray-800 hover:-translate-y-0.5 transition-all"
            >
