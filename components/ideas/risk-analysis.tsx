          ...
          <div key={idx} className="flex flex-col md:flex-row gap-0 border border-slate-200  rounded-xl overflow-hidden">
            <div className="flex-1 bg-amber-50  p-4 border-b md:border-b-0 md:border-r border-slate-200 ">
              <div className="flex gap-2 items-start">
                ...
                <div>
                  <span className="text-xs font-bold text-amber-700  uppercase tracking-wider block mb-1">Risk</span>
                  <p className="text-sm text-slate-800  font-medium">{item.risk}</p>
                </div>
              </div>
            </div>
            
            <div className="flex-1 bg-emerald-50/50  p-4">
              <div className="flex gap-2 items-start">
                <ShieldCheck className="w-4 h-4 text-emerald-600 mt-1 flex-shrink-0" />
                <div>
                  <span className="text-xs font-bold text-emerald-700  uppercase tracking-wider block mb-1">Mitigation</span>
